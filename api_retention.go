...
func (a *RetentionApiService) OperateRetentionExecution(ctx context.Context, id int64, eid int64, body interface{}, localVarOptionals *RetentionApiOperateRetentionExecutionOpts) (*http.Response, error) {
	var (
...
func (a *RetentionApiService) TriggerRetentionExecution(ctx context.Context, id int64, body interface{}, localVarOptionals *RetentionApiTriggerRetentionExecutionOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
